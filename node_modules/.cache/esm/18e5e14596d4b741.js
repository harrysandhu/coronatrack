let RESPONSES,BASE_DEV;_96d‍.x([["saveImage",()=>saveImage]]);_96d‍.w("./helperConstants",[["RESPONSES",["RESPONSES"],function(v){RESPONSES=v}],["BASE_DEV",["BASE_DEV"],function(v){BASE_DEV=v}]]);
var fs = require('fs')
 ...
 */
       async function saveImage(u_id, filename, imageData){
    ...
    return new Promise(async (resolve, reject) =>{
       // var ext = imageData.substring(11, imageData.indexOf(";base64")).toLowerCase()
        ...
        if(imageBuffer.hasOwnProperty("errorStatus")){
             _96d‍.g.console.log(new Error().stack.split(/\r\n|\r|\n/g)[1].trim())
