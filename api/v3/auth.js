...
var BusinessUser_1 = __importDefault(require("../../src/BusinessUser"));
...
auth.post("/business/signup", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var buser, error_1, signUpResult, er_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, BusinessUser_1.default(__assign({}, req.body.user))];
            case 1:
                buser = _a.sent();
                buser.setPassword(req.body.pfield.password, req.body.pfield.salt);
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                console.log(error_1);
            ...
            case 5:
                er_1 = _a.sent();
                console.log("error at business signup : ", er_1);
                return [2 /*return*/, res.json(er_1.get())];
            case 6: return [2 /*return*/];
        }
    });
}); });
auth.post("/signup", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_2, signUpResult, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, User_1.default(__assign({}, req.body.fields))];
            case 2:
                user = _a.sent();
                return [3 /*break*/, 4];
            case 3:
